function sendMoney(){
   ...
   if (enterAmount > enterSAmount) {
      ...
      ₹${enterAmount} is conveyed to ${enterName}@yahoo.com.`)

      // transaction history 
      var createPTag = document.createElement("li");
      var textNode = document.createTextNode(`₹ ${enterAmount} is sent from the sender with Email-id ${enterSName}@eyahoo.com
 to recepient with Email-id ${enterName}@yahoo.com on ${Date()}.`);
